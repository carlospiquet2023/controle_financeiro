...
export default async function Home() {
  ...
  const [accounts, cards, categories, people, monthTransactions, futureTransactions, openSplits] = await Promise.all([
